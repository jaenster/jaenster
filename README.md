...
| [**d2-dedicated-server**](https://github.com/jaenster/d2-dedicated-server) ⭐22 | Self-hosted cloud-native D2 1.14d realm + game server in Zig (modern PvPGN) |
...
| [**remote-shell-mcp**](https://github.com/jaenster/remote-shell-mcp) ⭐3 | Persistent SSH, SFTP, port-forwarding & Docker over MCP |
